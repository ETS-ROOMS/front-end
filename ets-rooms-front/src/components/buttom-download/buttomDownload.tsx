...
function Modal() {
  ...
  const allPeopleOption = { value: 'all', label: 'Selecionar Todos os instrutores' };
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="Frame" clip-path="url(#clip0_1353_3279)">
            <path id="Vector" d="M4 17V19C4 19.5304 4.21071 20.0391 4.58579 20.4142C4.96086 20.7893 5.46957 21 6 21H18C18.5304 21 19.0391 20.7893 19.4142 20.4142C19.7893 20.0391 20 19.5304 20 19V17" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path id="Vector_2" d="M7 11L12 16L17 11" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path id="Vector_3" d="M12 4V16" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </g>
        </svg>
      </button>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className='flex mt-4 justify-between'>
                <div className="mb-4 w-[40%] flex items-center">
                  <label htmlFor="dataInicio" className="block text-sm mr-2">*Início</label>
                  <DatePicker
                    id="dataInicio"
                    selected={dataInicio}
                ...
                <div className="mb-4 w-[40%] flex items-center">
                  <label htmlFor="dataFinal" className="block text-sm mr-2">*Fim</label>
                  <DatePicker
                    id="dataFinal"
                    selected={dataFinal}
              ...
              {/* INPUT DE INSTRUTOR */}
              <div className="mb-4 ">
                <label htmlFor="person" className="block font-semibold text-sm mb-2">Instrutores</label>
                <Select
                  id="person"
              ...
              {/* INPUT DE SALA */}
              <div className="mb-4">
                <label htmlFor="room" className="block font-semibold text-sm mb-2">Salas</label>
                <Select
                  id="room"
