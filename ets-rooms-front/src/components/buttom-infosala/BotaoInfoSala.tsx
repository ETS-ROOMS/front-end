                ...
                <div className="flex gap-2">
                  ...
                  >
                    <g clip-path="url(#clip0_1273_4178)">
                      ...
                      />
                      <path
                        d="M21.5 21V19C21.4949 18.1172 21.1979 17.2608 20.6553 16.5644C20.1126 15.868 19.3548 15.3707 18.5 15.15"
                        stroke="#007BC0"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M7 8C6.73478 8 6.48043 8.10536 6.29289 8.29289C6.10536 8.48043 6 8.73478 6 9V10C6 10.2652 5.89464 10.5196 5.70711 10.7071L5 11.4142V13.5858L5.70711 14.2929C5.89464 14.4804 6 14.7348 6 15V18C6 18.2652 6.10536 18.5196 6.29289 18.7071C6.48043 18.8946 6.73478 19 7 19H17C17.2652 19 17.5196 18.8946 17.7071 18.7071C17.8946 18.5196 18 18.2652 18 18V15C18 14.7348 18.1054 14.4804 18.2929 14.2929L19 13.5858V11.4142L18.2929 10.7071C18.1054 10.5196 18 10.2652 18 10V9C18 8.73478 17.8946 8.48043 17.7071 8.29289C17.5196 8.10536 17.2652 8 17 8H7ZM4.87868 6.87868C5.44129 6.31607 6.20435 6 7 6H17C17.7956 6 18.5587 6.31607 19.1213 6.87868C19.6839 7.44129 20 8.20435 20 9V9.58579L20.7071 10.2929C20.8946 10.4804 21 10.7348 21 11V14C21 14.2652 20.8946 14.5196 20.7071 14.7071L20 15.4142V18C20 18.7957 19.6839 19.5587 19.1213 20.1213C18.5587 20.6839 17.7957 21 17 21H7C6.20435 21 5.44129 20.6839 4.87868 20.1213C4.31607 19.5587 4 18.7956 4 18V15.4142L3.29289 14.7071C3.10536 14.5196 3 14.2652 3 14V11C3 10.7348 3.10536 10.4804 3.29289 10.2929L4 9.58579V9C4 8.20435 4.31607 7.44129 4.87868 6.87868Z"
                      fill="#007BC0"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M9 16C9 15.4477 9.44772 15 10 15H14C14.5523 15 15 15.4477 15 16C15 16.5523 14.5523 17 14 17H10C9.44772 17 9 16.5523 9 16Z"
                      fill="#007BC0"
                    />
                    <path
                      d="M8.5 12C8.77614 12 9 11.7761 9 11.5C9 11.2239 8.77614 11 8.5 11C8.22386 11 8 11.2239 8 11.5C8 11.7761 8.22386 12 8.5 12Z"
                      fill="#007BC0"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M8.5 12C8.77614 12 9 11.7761 9 11.5C9 11.2239 8.77614 11 8.5 11C8.22386 11 8 11.2239 8 11.5C8 11.7761 8.22386 12 8.5 12ZM7 11.5C7 10.6716 7.67157 10 8.5 10C9.32843 10 10 10.6716 10 11.5C10 12.3284 9.32843 13 8.5 13C7.67157 13 7 12.3284 7 11.5Z"
                      fill="#007BC0"
                    />
                    <path
                      d="M15.5 12C15.7761 12 16 11.7761 16 11.5C16 11.2239 15.7761 11 15.5 11C15.2239 11 15 11.2239 15 11.5C15 11.7761 15.2239 12 15.5 12Z"
                      fill="#007BC0"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M15.5 12C15.7761 12 16 11.7761 16 11.5C16 11.2239 15.7761 11 15.5 11C15.2239 11 15 11.2239 15 11.5C15 11.7761 15.2239 12 15.5 12ZM14 11.5C14 10.6716 14.6716 10 15.5 10C16.3284 10 17 10.6716 17 11.5C17 12.3284 16.3284 13 15.5 13C14.6716 13 14 12.3284 14 11.5Z"
                      fill="#007BC0"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M7.7577 2.02985C8.2935 1.8959 8.83643 2.22166 8.97038 2.75746L9.97038 6.75746C10.1043 7.29325 9.77857 7.83619 9.24277 7.97013C8.70698 8.10408 8.16404 7.77832 8.03009 7.24253L7.03009 3.24253C6.89615 2.70673 7.22191 2.1638 7.7577 2.02985Z"
                      fill="#007BC0"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M16.2428 2.02985C16.7786 2.1638 17.1043 2.70673 16.9704 3.24253L15.9704 7.24253C15.8364 7.77832 15.2935 8.10408 14.7577 7.97013C14.2219 7.83619 13.8961 7.29325 14.0301 6.75746L15.0301 2.75746C15.164 2.22166 15.707 1.8959 16.2428 2.02985Z"
                      fill="#007BC0"
                    />
                  </svg>
